...
<div class="tools_tabs">
	...
	<div class="tools_tabs_right" style="display: none;"><ul><li style="padding: 0px;font-size: 12px;line-height: 22px;"><a href="http://support.diaowen.net/" target="_black" style="text-decoration: none;color: gray;">帮助</a></li></ul></div>
</div>
									...
									<div class="surveyQuItemContent">
										...
										<div class="quCoItem"><ul>
											<li class="quCoItemUlLi">
												<!-- <input type="text" style="width:200px;padding:5px;"> -->
												<div class="quFillblankItem">
													<input type="text" style="width:200px;padding:5px;" class="quFillblankAnswerInput" id="emailInput"/>
													<textarea rows="5" style="width:300px;display: none;"class="quFillblankAnswerTextarea" ></textarea>
													<div class="dwFbMenuBtn" ></div>
												</div>
											</li>
							...
							<div class="surveyQuItemBody quDragBody">
								...
								<div class="surveyQuItem">
									...
									<div class="surveyQuItemContent">
										<div class="quCoTitle">
											<div class="quCoNum">1、</div>
											<div class="editAble quCoTitleEdit" >您的手机号是？</div>
											<input type="hidden" name="quTitleSaveTag" value="0">
										</div>
										<div class="quCoItem"><ul>
											<li class="quCoItemUlLi">
												<!-- <input type="text" style="width:200px;padding:5px;"> -->
												<div class="quFillblankItem">
													<input type="text" style="width:200px;padding:5px;" class="quFillblankAnswerInput" id="mobileInput"/>
													<textarea rows="5" style="width:300px;display: none;"class="quFillblankAnswerTextarea" ></textarea>
													<div class="dwFbMenuBtn" ></div>
												</div>
											</li>
						...
						<div class="dwQuTypeModel">
							<div class="surveyQuItemBody quDragBody">
								...
								<div class="quInputCase" style="display: none;">
									...
									<input type="hidden" name="contactsAttr" value="1">
									<input type="hidden" name="contactsField" value="10">
						...
						<div class="dwQuTypeModel">
							<div class="surveyQuItemBody quDragBody">
								...
								<div class="quInputCase" style="display: none;">
									...
									<input type="hidden" name="contactsAttr" value="1">
									<input type="hidden" name="contactsField" value="7">
									<div class="quLogicInputCase">
										<input type="hidden" name="quLogicItemNum" value="0">
									</div>
								</div>
								<div class="surveyQuItem">
									...
									<div class="surveyQuItemContent">
										<div class="quCoTitle">
											<div class="quCoNum">1、</div>
											<div class="editAble quCoTitleEdit" >您的学校是？</div>
											<input type="hidden" name="quTitleSaveTag" value="0">
										</div>
										<div class="quCoItem"><ul>
											<li class="quCoItemUlLi">
												<!-- <input type="text" style="width:200px;padding:5px;"> -->
												<div class="quFillblankItem">
													<input type="text" style="width:200px;padding:5px;" class="quFillblankAnswerInput" id="selectSchool" readonly="readonly" />
													<textarea rows="5" style="width:300px;display: none;"class="quFillblankAnswerTextarea" ></textarea>
													<div class="dwFbMenuBtn" ></div>
												</div>
											</li>
									...
									<div class="quCoItem"><ul>
										<li class="quCoItemUlLi">
											...
											<c:choose>
												...
												<c:otherwise>
													<input type="text" style="width:${empty(en.answerInputWidth)?'300':en.answerInputWidth}px;padding:5px;" class="quFillblankAnswerInput" id="${en.answerInputId}">
		...
		<div class="dwCommonDialogContent">
			...
			<div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon" >
				<ul>
					...
					<li><label><input type="checkbox" name="setIsRequired"  ></label> </li>
			...
			<div class="tabbarDialog_1" >
					...
					<div class="p_DialogContent" >
						...
						<div class="p_DialogContentRoot">
								...
								<div class="p_DialogContentItem" style="display: none;"><label><input type="checkbox" name="ynEndTime" value="1"> 到&nbsp;<input type="text" size="20"  class="inputSytle_1 Wdate" onfocus="WdatePicker({minDate:'%y-%M-{%d+1}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="endTime">&nbsp;时结束 </label></div>
						</div>
					</div>
